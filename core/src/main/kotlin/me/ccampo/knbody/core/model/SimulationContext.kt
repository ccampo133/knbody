...
import me.ccampo.knbody.core.physics.gravityAcceleration
import me.ccampo.knbody.core.physics.verlet
import me.ccampo.knbody.core.util.isWayOutOfBounds
...
class SimulationContext(
        val dt: Double,
        val initBodies: Set<Body> = emptySet(),
        val width: Int = 100,
        val height: Int = 100,
        val nPos: Int = 0,
        val nOld: Int = 0) {
